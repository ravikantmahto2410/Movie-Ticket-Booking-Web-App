  ...
  return nowPlayingMovies.length > 0 ? (
    <>
      ...
      <div className="mt-8">
          ...
          <div className='inline-flex items-center gap-32 border border-gray-600
                ...
                <div className='flex flex-wrap gap-2 mt-1 text-sm'>
                  {times.map((time) => (
                    <div 
                      ...
                      <span>{time}</span>
                      <DeleteIcon
                        onClick={() => handleRemoveTime(date,time)} width={15}
                        className="ml-2 text-red-500 hover:text-red-700 curosr-pointer"
                      />
                    </div>
                  ))}
                </div>
